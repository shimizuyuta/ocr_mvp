...
export default function HomePage() {
  ...
  const [result, setResult] = useState<OCRResponse | OCRErrorResponse | null>(null);
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-2">名刺OCR解析</h1>
            <p className="text-gray-600">名刺の画像をアップロードして、自動で情報を抽出します</p>
          </div>
